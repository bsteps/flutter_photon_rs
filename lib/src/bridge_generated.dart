...
abstract class FlutterPhotonRs {
...
class FlutterPhotonRsImpl extends FlutterRustBridgeBase<FlutterPhotonRsWire>
    implements FlutterPhotonRs {
  factory FlutterPhotonRsImpl(ffi.DynamicLibrary dylib) =>
      FlutterPhotonRsImpl.raw(FlutterPhotonRsWire(dylib));

  FlutterPhotonRsImpl.raw(FlutterPhotonRsWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class FlutterPhotonRsWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  FlutterPhotonRsWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterPhotonRsWire.fromLookup(
