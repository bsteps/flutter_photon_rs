...
class FlutterPhotonImpl extends FlutterRustBridgeBase<FlutterPhotonWire>
    implements FlutterPhoton {
  factory FlutterPhotonImpl(ffi.DynamicLibrary dylib) =>
      FlutterPhotonImpl.raw(FlutterPhotonWire(dylib));

  FlutterPhotonImpl.raw(FlutterPhotonWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class FlutterPhotonWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  FlutterPhotonWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterPhotonWire.fromLookup(
